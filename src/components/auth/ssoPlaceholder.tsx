...
export default function SSOPlaceholder({
  ...
  return (
    <>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, margin: '20px 0' }}>
        ...
        <span style={{ fontSize: 11, color: B.light, fontWeight: 500, whiteSpace: 'nowrap' }}>
          {dividerText}
        </span>
        <div style={{ flex: 1, height: 1, background: B.border }} />
      </div>
      ...
      <div style={{ textAlign: 'center', marginTop: 8, fontSize: 11, color: B.light }}>
        SSO coming soon
      </div>
    </>
  )
