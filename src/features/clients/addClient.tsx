...
export default function AddClient({ navigate = () => {} }: { navigate?: (route: string) => void }) {
  ...
  const [personalMsg, setPersonalMsg] = useState(
    "Hi {name}, this is Jane from Walker & Co. We're setting up your Making Tax Digital account. You'll receive an email from HMRC shortly — please accept the authorisation link so we can manage your quarterly updates."
  )
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              ...
              >
                ...
                <div style={{ marginBottom: 20 }}>
                  ...
                  <div style={{ fontSize: 10, color: B.light, marginTop: 3 }}>
                    Sent alongside the HMRC invitation link. Use {'{name}'} for auto-replacement.
                  </div>
                </div>
                ...
                >
                  <button
                    ...
                    style={{
                      ...
                      background: formComplete ? B.green : B.xlight,
                      color: formComplete ? '#fff' : B.muted,
                      transition: 'all 0.2s',
                    }}
                  >
                    Send HMRC invitation
                  </button>
                </div>
              </div>
            )}
            ...
            {mode === 'single' && sent && (
              ...
              >
                ...
                >
                  Your personal message and HMRC authorisation link have been sent to {clientEmail}.
                  The client needs to sign in with their Government Gateway credentials to accept.
                </div>
                <div
                  style={{
                    marginTop: 16,
                ...
                >
                  The invitation expires in 21 days. You&#39;ll be notified when the client accepts.
                </div>
                <button
                  onClick={() => {
                    setSent(false)
              ...
              >
                ...
                >
                  ...
                  <div style={{ fontSize: 12, color: B.light }}>
                    Required columns: NINO, Client name, Email
                  </div>
                </div>
                ...
                {pendingInvites.map((inv, i) => (
                  <div
                    ...
                    style={{
                      padding: '12px 0',
                      borderBottom:
                        i < pendingInvites.length - 1 ? `1px solid ${B.borderLight}` : 'none',
                    }}
                  >
                    <div
                      style={{
                    ...
                    >
                      <span style={{ fontSize: 11, color: B.light }}>
                        Sent {inv.sent} — {inv.daysLeft}d left
                      </span>
                      <button
                        style={{
                          fontSize: 11,
              ...
              <div style={{ padding: '14px 20px' }}>
                {[
                  ...
                  },
                  {
                    ...
                    d: "They get your message plus a link to HMRC's Government Gateway",
                  },
                  {
                    n: '3',
                    t: 'Client accepts',
