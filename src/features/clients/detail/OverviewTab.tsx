      ...
      <div style={{ padding: '16px 20px' }}>
        ...
        >
          <span style={{ fontSize: 12, color: B.purpleText }}>
            Per-quarter income and expense figures will be available once the Income Sources API
            integration is live. Predictive tax liability will follow when Dashanalytix integration
            is live.
          </span>
        </div>
      </div>
            ...
            >
              ...
              <span
                style={{
                  ...
                  color: idx === 2 ? '#60A5FA' : B.blueText,
                  fontStyle: idx === 2 ? 'italic' : 'normal',
                }}
              >
                {v}
              </span>
