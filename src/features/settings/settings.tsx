            ...
            {sections.map((s) => (
              <div
                ...
                style={{
                  ...
                  borderRadius: 8,
                  cursor: 'pointer',
                  background: section === s.k ? B.white : 'transparent',
                  border: `1px solid ${section === s.k ? B.border : 'transparent'}`,
                  fontSize: 13,
                  fontWeight: section === s.k ? 600 : 400,
                  color: section === s.k ? B.text : B.muted,
                }}
              >
              ...
              <Card>
                ...
                <div style={{ padding: '20px' }}>
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                    {[
                      ['Firm name', 'Walker & Co Accountants'],
                      ['Primary contact', 'Jane Walker'],
                      ['Email', 'jane@walkerco.co.uk'],
                      ['Phone', '01234 567890'],
                    ].map(([l, v], i) => (
                      <div key={i}>
                        <label
                    ...
                    <div style={{ gridColumn: '1/-1' }}>
                      ...
                      <input
                        defaultValue="14 High Street, Slough, SL1 1AA"
                        style={{
                          width: '100%',
                          padding: '9px 14px',
                          borderRadius: 8,
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                <Card>
                  ...
                  <div style={{ padding: '20px' }}>
                    ...
                    >
                      <div
                        style={{ width: 10, height: 10, borderRadius: 5, background: B.green }}
                      />
                      <div>
                    ...
                    {[
                      ...
                      <div
                        ...
                        style={{
                          ...
                          alignItems: 'center',
                          padding: '7px 0',
                          borderBottom: i < 8 ? `1px solid ${B.borderLight}` : 'none',
                        }}
                      >
                  ...
                  {[
                    ...
                    <div
                      ...
                      style={{
                        ...
                        gap: 14,
                        padding: '14px 0',
                        borderBottom: idx < 2 ? `1px solid ${B.borderLight}` : 'none',
                      }}
                    >
                      <div
                        style={{
            ...
            {section === 'notifications' && (
              <Card>
                ...
                <div style={{ padding: '12px 20px 20px' }}>
                  ...
                  >
                    Chase delivery channels
                  </div>
                  <Toggle
                    on={chaseEmail}
                    onChange={setChaseEmail}
                  ...
                  {[
                    ...
                    <div
                      ...
                      style={{
                        ...
                        justifyContent: 'space-between',
                        padding: '9px 0',
                        borderBottom: i < 3 ? `1px solid ${B.borderLight}` : 'none',
                      }}
                    >
                      <span style={{ fontSize: 12, color: B.muted }}>{k}</span>
