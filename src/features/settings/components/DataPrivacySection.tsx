    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      >
        ...
        <div style={{ padding: '20px' }}>
          ...
          >
            Download a copy of all your firm&apos;s data held in My Tax Diary, including firm
            details, client records, notes, chase history, and portal messages. The export is a ZIP
            file containing JSON and CSV files. Passwords, HMRC tokens, and encryption keys are
            never included.
          </div>
            ...
            >
              ...
              <input
                ...
                style={{
                  ...
                  padding: '10px 12px',
                  borderRadius: 8,
                  border: `1px solid ${exportError ? B.red : B.border}`,
                  fontSize: 13,
                  outline: 'none',
                  marginBottom: 12,
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 8,
                    border: 'none',
                    background: exportPassword.trim() ? B.primary : B.xlight,
                    color: exportPassword.trim() ? '#fff' : B.muted,
                    fontSize: 13,
                    fontWeight: 600,
                    cursor: exportPassword.trim() ? 'pointer' : 'not-allowed',
                  }}
                >
                  Download ZIP
                </button>
      ...
      >
        ...
        >
          Passwords, password hashes, HMRC access tokens, TOTP secrets, and encryption keys are
          never exported.
        </div>
      </div>
      ...
      >
        Under UK GDPR you have the right to access and receive a copy of the personal data we hold
        about you. This export fulfils that right. If you need help, contact us at{' '}
        ...
        <div style={{ padding: '20px' }}>
            ...
            <div>
              ...
              >
                ...
                <div style={{ fontSize: 13, color: B.muted, lineHeight: 1.6 }}>
                  Your account and all firm data will be permanently deleted on this date. You can
          ...
          {(deletePhase === 'idle' ||
            ...
            <div>
              ...
              >
                Permanently delete your account and all associated firm data. A 7-day grace period
                applies. A confirmation email will be sent. Billing records are retained for legal
                compliance.
              </div>
              ...
              {(deletePhase === 'confirm' || deletePhase === 'requesting') && (
                ...
                >
                  <div style={{ fontSize: 13, fontWeight: 700, color: B.redText, marginBottom: 4 }}>
                    This cannot be undone
                  </div>
                  <div style={{ fontSize: 12, color: B.muted, marginBottom: 14, lineHeight: 1.6 }}>
                    All clients, notes, chase logs, portal data, and uploaded files will be
                    permanently deleted after 7 days. Type <strong>delete</strong> below and enter
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 10, maxWidth: 360 }}>
                    ...
                    {mfaEnabled && (
                      <input
                        ...
                        value={deleteMfaCode}
                        onChange={(e) => {
                          setDeleteMfaCode(e.target.value.replace(/\D/g, '').slice(0, 6))
                          setDeleteError(null)
                        }}
                        ...
                        return (
                          <button
                            ...
                            style={{
                              ...
                              borderRadius: 8,
                              border: 'none',
                              background: canSubmit ? B.red : B.xlight,
                              color: canSubmit ? '#fff' : B.muted,
                              fontSize: 13,
                              fontWeight: 600,
