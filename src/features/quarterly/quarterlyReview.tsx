      ...
      <div style={{ flex: 1, overflow: 'auto', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            {submitted && (
              ...
              >
                ...
                <span style={{ fontSize: 13, fontWeight: 700, color: B.greenText }}>
        ...
        <div style={{ padding: '24px 32px', flex: 1 }}>
          ...
          >
            ...
            <div>
              <div style={{ fontSize: 13, fontWeight: 600, color: B.blueText }}>
                This is what HMRC will receive
              </div>
              <div style={{ fontSize: 12, color: '#0369A1' }}>
                Cumulative year-to-date totals for self-employment income source XAIS12345678901.
                This submission replaces all prior quarterly updates for 2025-26.
              </div>
            </div>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: 20 }}>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
                  ...
                  <tbody>
                    <tr style={{ borderBottom: `1px solid ${B.borderLight}` }}>
                      ...
                      >
                        £{incomeData.turnover.toLocaleString()}
                      </td>
                      <td
                        style={{
                          padding: '12px 20px',
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
                  ...
                  <tbody>
                    {expenseRows.map((r, i) => (
                      ...
                      >
                        <td style={{ padding: '10px 20px', color: r.q4 > 0 ? B.text : B.light }}>
                          {r.cat}
                        </td>
                        <td
                          style={{
                        ...
                        >
                          ...
                          {r.q4 > 0 && r.prior > 0 && (
                            ...
                            >
                              {r.q4 > r.prior
                                ? `+${Math.round(((r.q4 - r.prior) / r.prior) * 100)}%`
                                : r.q4 < r.prior
                                  ? `${Math.round(((r.q4 - r.prior) / r.prior) * 100)}%`
                                  : ''}
                            </span>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                  ...
                  {checks.map((c, i) => (
                    <div
                      ...
                      style={{
                        ...
                        gap: 10,
                        padding: '9px 0',
                        borderBottom: i < checks.length - 1 ? `1px solid ${B.borderLight}` : 'none',
                    ...
                    >
                      <div
                        style={{
                          ...
                          fontSize: 10,
                          fontWeight: 700,
                          color: c.ok && !c.warn ? B.greenText : B.amberText,
                        }}
                      >
                        {c.ok && !c.warn ? '✓' : '!'}
                      </div>
                      <span
                        style={{
                          fontSize: 12,
                          color: c.warn ? B.amberText : B.text,
                          lineHeight: 1.5,
                        }}
                      >
                        {c.msg}
                  ...
                  {[
                    ...
                    <div
                      ...
                      style={{
                        ...
                        justifyContent: 'space-between',
                        padding: '6px 0',
                        borderBottom: i < 6 ? `1px solid ${B.borderLight}` : 'none',
                      }}
                    >
                      ...
                      <span
                        style={{
                          fontSize: 11,
                          fontWeight: 500,
                          fontFamily: k === 'NINO' || k === 'Business ID' ? 'monospace' : 'inherit',
                        }}
                      >
                        {v}
                      </span>
              ...
              >
                <div style={{ fontSize: 11, fontWeight: 600, color: B.amberText, marginBottom: 4 }}>
                  HMRC disclaimer
                </div>
                <div style={{ fontSize: 11, color: '#78350F', lineHeight: 1.6 }}>
                  This submission will fulfil the Q4 2025-26 quarterly update obligation. Once
                  submitted, figures can be amended by submitting a new cumulative update. You are
                  responsible for the accuracy of the data submitted.
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <div style={{ padding: '24px 28px 0' }}>
              <div style={{ fontSize: 18, fontWeight: 700, letterSpacing: '-0.02em' }}>
                Confirm HMRC submission
              </div>
              <div style={{ fontSize: 13, color: B.muted, marginTop: 8, lineHeight: 1.6 }}>
                You are about to submit the Q4 cumulative update for <b>Priya Sharma</b> (Sharma
                Design Studio) to HMRC. This will fulfil the Q4 2025-26 obligation.
              </div>
              ...
              >
                ...
                >
                  ...
                  <span style={{ fontSize: 15, fontWeight: 800, color: B.greenText }}>
                    £{netProfit.toLocaleString()}
                  </span>
                </div>
              </div>
              ...
              >
                This action submits data to HMRC and fulfils a legal obligation. Ensure the figures
                are correct before proceeding. Amendments can be made by submitting a revised
                cumulative update.
              </div>
            </div>
