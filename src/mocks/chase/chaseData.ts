...
export const mockChaseClients: ChaseClient[] = [
  {
    ...
    status: 'no-response',
    channel: 'email',
    workflowType: 'data-request',
  },
  {
    id: 2,
    name: 'James Cooper',
    business: 'Cooper Properties',
    deadline: '7 Feb 2026',
    daysOverdue: 77,
    lastChase: '14 Apr',
    chaseCount: 2,
    status: 'opened',
    channel: 'email',
    workflowType: 'bookkeeping',
  },
  {
    id: 4,
    name: 'Tom Grant',
    business: 'Grant Rentals',
    deadline: '7 May 2026',
    daysOverdue: -13,
    lastChase: '16 Apr',
    chaseCount: 1,
  ...
  },
  {
    ...
    business: 'Whitfield Electricals',
    deadline: '7 May 2026',
    daysOverdue: -13,
    lastChase: '12 Apr',
    chaseCount: 1,
