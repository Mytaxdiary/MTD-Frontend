    ...
    >
      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '56px 24px 80px' }}>
        <div style={{ marginBottom: 48 }}>
          ...
          <p style={{ margin: 0, fontSize: 15, color: '#64748B' }}>Effective date: 20 July 2026</p>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 40 }}>
          <Section num="1" title="Who We Are">
            <P>
              ...
              Dowry St, Oldham OL8 2PF, collects and uses personal data in connection with the My
              Tax Diary website and platform (the &quot;Service&quot;).
            </P>
            <P>
              We are registered with the Information Commissioner&apos;s Office (ICO) under
              registration number <strong>ZC190729</strong>.
            </P>
          </Section>

          <Section num="2" title="Two Roles We Play">
            <P>
              Because of how the Service works, we act in two different capacities under data
              protection law, and it matters which one applies to a given piece of data:
            </P>
            <P>
              <strong>As data controller:</strong> for data about you as our Customer or an
              Authorised User of your account (for example, your name, work email, and billing
              details), where we decide how and why that data is used. This is covered in sections 3
              to 6 below.
            </P>
            <P>
              <strong>As data processor:</strong> for the Client Data your firm provides to the
              Service, or retrieves through the Service via the HMRC API, about your own clients.
              Here, your firm is the controller and we only process that data on your documented
              instructions, under a separate Data Processing Agreement. This is covered in section
              7.
            </P>
          </Section>
          ...
          <Section num="5" title="Cookies and Analytics">
            <P>
              We use essential cookies necessary for the Service to function (such as keeping you
              logged in) and analytics cookies via Google Analytics to understand how the site is
              used. Non-essential cookies are only set with your consent, which you can manage or
              withdraw via our cookie banner or your browser settings.
            </P>
            <P>
              Google Analytics may process data outside the UK; where it does, Google provides
              appropriate safeguards such as the UK International Data Transfer Addendum or
          ...
          <Section num="7" title="Client Data We Process on Your Instructions">
            <P>
              Where your firm uses the Service to retrieve or track information about your own
              clients via the HMRC API, such as agent authorisation status, submission history, or
              liability visibility, we process that data solely as a processor, on your documented
              instructions, for the purpose of providing the Service to you.
            </P>
            <P>
              ...
              provider), as set out in our Data Processing Agreement. Your firm remains the
              controller responsible for the lawful basis on which Client Data is collected and
              processed, and for your own obligations to your clients under UK GDPR.
            </P>
          </Section>
          ...
          <Section num="8" title="International Transfers">
            <P>
              ...
              Economic Area (Germany and Finland). Transfers of personal data from the UK to the EEA
              are made under the UK&apos;s adequacy regulations, which permit such transfers without
              additional safeguards.
            </P>
            <P>
              Where any other providers listed above process personal data outside the UK, we ensure
              appropriate safeguards are in place, such as adequacy regulations or standard
              contractual clauses/the UK International Data Transfer Addendum. We keep our transfer
              arrangements under review to reflect any changes in the UK&apos;s adequacy decisions.
            </P>
          </Section>

          <Section num="9" title="Data Retention">
            <P>
              We retain Customer account and billing data for as long as your Subscription is
              active, and for six years afterwards in line with standard UK accounting and tax
              record-keeping obligations. Client Data is retained in accordance with your
              instructions as controller and our Data Processing Agreement, and is deleted or
              returned within 30 days of contract termination unless you request otherwise or we are
          ...
          <Section num="11" title="Your Rights">
            <P>
              If you are an individual whose personal data we control (see section 2), you have the
              right to:
            </P>
            <BulletList
              items={[
            ...
            <P>
              ...
              <a href="mailto:info@mytaxdiary.co.uk" style={{ color: '#2563EB' }}>
            ...
            <P>
              If your personal data is processed by us as part of Client Data (i.e. you are a client
              of one of our Customer accountancy firms), please contact that firm directly, as they
              are the data controller for that data.
            </P>
          </Section>

          <Section num="12" title="Children">
            <P>
              The Service is intended for business use by professional firms and is not directed at,
              or intended for use by, children.
            </P>
          </Section>
          ...
          <Section num="13" title="Changes to This Policy">
            <P>
              ...
              practices or legal requirements. Material changes will be notified via email or in-app
              notice.
            </P>
          </Section>
          ...
          <Section num="14" title="Contact Us">
            <P>
              For any questions about this Privacy Policy or how we handle personal data, contact us
              at{' '}
              <a href="mailto:info@mytaxdiary.co.uk" style={{ color: '#2563EB' }}>
                info@mytaxdiary.co.uk
              </a>
...
function Section({
  ...
  return (
    <div>
      ...
      >
        <span style={{ fontSize: 13, fontWeight: 700, color: '#2563EB', minWidth: 22 }}>
          {num}.
        </span>
        {title}
      </h2>
...
function BulletList({ items }: { items: string[] }) {
  return (
    <ul style={{ margin: '0 0 12px', paddingLeft: 20 }}>
      {items.map((item, i) => (
        <li key={i} style={{ fontSize: 14, color: '#374151', lineHeight: 1.75, marginBottom: 6 }}>
          {item}
        </li>
      ))}
    </ul>
