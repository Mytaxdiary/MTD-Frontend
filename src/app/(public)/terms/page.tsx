      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '56px 24px 80px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 40 }}>
          <Section num="1" title="About These Terms">
            <P>
              These Terms and Conditions (&quot;Terms&quot;) govern access to and use of the My Tax
              Diary website and platform (the &quot;Service&quot;) provided by My Tax Diary Ltd
              (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;), a company registered in England and
              Wales under company number <strong>17312332</strong> with its registered office at
              Suite 6, Earl Business Centre, Dowry St, Oldham OL8 2PF.
            </P>
            <P>
              The Service is provided to accountancy firms, tax agents, and similar professional
              practices (&quot;you&quot;, &quot;your firm&quot;, the &quot;Customer&quot;). By
              creating an account, accessing, or using the Service, you agree to these Terms on
              behalf of your firm. If you do not agree, you must not use the Service.
            </P>
            <P>
              These Terms apply together with our Privacy Policy and our Data Processing Agreement
              (&quot;DPA&quot;), which forms part of these Terms where we process Client Data on
              your behalf.
            </P>
          </Section>
          ...
          <Section num="2" title="What the Service Does">
            <P>
              My Tax Diary is a read-only visibility and monitoring platform. It connects to HM
              Revenue and Customs (&quot;HMRC&quot;) Making Tax Digital (&quot;MTD&quot;) Income Tax
              Self Assessment APIs to retrieve and display information relating to your clients,
              such as agent authorisation status, business details, obligations and deadlines,
              submission history, and liability information (&quot;Client Data&quot;), so that your
              firm can monitor its client base in one place.
            </P>
          </Section>
          ...
          <Section num="5" title="Our Responsibilities">
            ...
            <P>
              ...
              availability, accuracy, or performance of HMRC&apos;s systems, for changes HMRC makes
              to its APIs, or for any decision HMRC takes in relation to your firm or your clients.
            </P>
          </Section>
          ...
          <Section num="7" title="Intellectual Property">
            <P>
              ...
              its software, design, and branding. We grant your firm a non-exclusive,
              non-transferable licence to use the Service for your internal business purposes during
              your subscription. Client Data and your firm&apos;s data remain yours; you grant us a
              licence to process them only as needed to provide the Service, as set out in the DPA.
            </P>
          </Section>

          <Section num="8" title="Data Protection">
            <P>
              Each party will comply with applicable data protection law, including UK GDPR and the
              Data Protection Act 2018. Our processing of personal data is described in our{' '}
              <Link href="/privacy-policy" style={{ color: '#2563EB' }}>
                Privacy Policy
              </Link>
              . Where we process Client Data on your behalf, we do so as processor under the DPA,
              and your firm remains the controller.
            </P>
          </Section>
          ...
          <Section num="9" title="Liability">
            <P>
              ...
              liability that cannot be excluded or limited under the law of England and Wales.
            </P>
          ...
          <Section num="10" title="Suspension">
            <P>
              We may suspend access to the Service, in whole or in part, where reasonably necessary:
              for maintenance or security; where we reasonably believe your use breaches these Terms
              or applicable law; where required by HMRC or a regulator; or where fees are overdue as
              described in section 6. Where practicable, we will give you notice and an opportunity
              to remedy the issue before suspending.
            </P>
          </Section>
          ...
          <Section num="12" title="Changes to the Service and These Terms">
            <P>
              ...
              its core functionality during your paid subscription period. We may update these Terms
              from time to time; material changes will be notified to you by email or in-app notice
              at least 30 days before they take effect. If you do not accept a material change, you
          ...
          <Section num="14" title="Governing Law and Jurisdiction">
            <P>
              ...
              Service (including non-contractual disputes or claims), are governed by the law of
        ...
        >
          <Link href="/privacy-policy" style={{ color: '#2563EB', textDecoration: 'none' }}>
            Privacy Policy
          </Link>
