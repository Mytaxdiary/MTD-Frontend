...
const Card = ({ children }) => <div style={{ background:B.white, borderRadius:12, border:`1px solid ${B.border}`, overflow:"hidden" }}>{children}</div>;
const CardHead = ({ title, sub }) => (<div style={{ padding:"16px 20px", borderBottom:`1px solid ${B.border}` }}><div style={{ fontSize:15, fontWeight:700 }}>{title}</div>{sub && <div style={{ fontSize:12, color:B.muted, marginTop:2 }}>{sub}</div>}</div>);
  ...
  return (
    <div style={{ display:"flex", height:"100vh", fontFamily:"'DM Sans','Segoe UI',system-ui,sans-serif", background:B.surface, color:B.text }}>
      <div style={{ width:230, background:B.navy, display:"flex", flexDirection:"column", flexShrink:0 }}>
        <div style={{ padding:"22px 20px 20px", borderBottom:"1px solid rgba(255,255,255,0.08)" }}><div style={{ display:"flex", alignItems:"center", gap:10 }}><div style={{ width:32, height:32, borderRadius:8, background:`linear-gradient(135deg,${B.primary},${B.primaryDark})`, display:"flex", alignItems:"center", justifyContent:"center", fontWeight:800, fontSize:13, color:"#fff" }}>NE</div><div><div style={{ fontSize:14, fontWeight:700, color:"#fff" }}>NewEffect</div><div style={{ fontSize:10, color:"rgba(255,255,255,0.4)", fontWeight:500 }}>MTD ITSA</div></div></div></div>
        <div style={{ padding:"16px 12px", flex:1 }}>
          ...
          <NavItem label="Dashboard" icon="⊞" /><NavItem label="Clients" icon="⊡" /><NavItem label="Chase manager" icon="↗" count={2} />
          ...
          <NavItem label="Add client" icon="+" /><NavItem label="Settings" active icon="⚙" /><NavItem label="HMRC connection" icon="⟷" />
        </div>
      ...
      <div style={{ flex:1, overflow:"auto", display:"flex", flexDirection:"column" }}>
        <div style={{ padding:"16px 32px", background:B.white, borderBottom:`1px solid ${B.border}`, flexShrink:0 }}><div style={{ fontSize:20, fontWeight:700 }}>Settings</div><div style={{ fontSize:13, color:B.muted, marginTop:2 }}>Manage your firm, HMRC connection, team, and preferences</div></div>
        <div style={{ padding:"24px 32px", flex:1 }}>
          <div style={{ display:"grid", gridTemplateColumns:"200px 1fr", gap:24 }}>
            ...
            <div>
              {section==="firm" && (
                <Card><CardHead title="Firm details" sub="Your practice information" /><div style={{ padding:"20px" }}>
              ...
              {section==="hmrc" && (
                <div style={{ display:"flex", flexDirection:"column", gap:20 }}>
                  <Card><CardHead title="HMRC connection status" sub="OAuth 2.0 via Government Gateway" /><div style={{ padding:"20px" }}>
                  ...
                  <Card><CardHead title="API subscriptions" /><div style={{ padding:"8px 20px 14px" }}>
              ...
              {section==="team" && (
                <Card><CardHead title="Team members" /><div style={{ padding:"8px 20px 14px" }}>
              ...
              {section==="billing" && (
                <Card><CardHead title="Plan & billing" /><div style={{ padding:"20px" }}>
